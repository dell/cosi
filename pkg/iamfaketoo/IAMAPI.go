...
type mockConstructorTestingTNewIAMAPI interface {
	mock.TestingT
	Cleanup(func())
}

// NewIAMAPI creates a new instance of IAMAPI. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewIAMAPI(t mockConstructorTestingTNewIAMAPI) *IAMAPI {
	mock := &IAMAPI{}
	mock.Mock.Test(t)
...
// func (_m *IAMAPI) RetryRules(_a0 *request.Request) time.Duration {
// 	ret := _m.Called(_a0)
...
// func (_m *IAMAPI) ShouldRetry(_a0 *request.Request) bool {
// 	ret := _m.Called(_a0)

...
Feature: Bucket creation on ObjectScale platform
    ...
    Scenario: Successfull bucket creation
        ...
        Then Bucket resource referencing BucketClaim resource "bucket-claim-valid" is created in ObjectStore "${objectstoreId}"
    ...
    Scenario: Unsuccessfull bucket creation
        ...
        Then Bucket resource referencing BucketClaim resource "bucket-claim-invalid" is not created in ObjectStore "${objectstoreId}"
